...
public interface GameApi extends ActiveApi<MainGame, Long> {
	 ...
	 *
	 * @param identifier {@link Category} identifier
	 *
	 * @param startPosition amount of results to skip @param maxResult amount of
	 * results @return {@link MainGame} ids for a given {@link Category}
	 */
	 ...
	 * Can be used for pagination
	 *
	 * @param identifier identifier of {@link Developer}
	 *
	 * @param startPosition amount of results to skip @param maxResult amount of
	 * results @return {@link MainGame} ids for a given {@link Developer}
	 */
	 ...
	 * Can be used for pagination
	 *
	 * @param identifier identifier of {@link Serie}
	 *
	 * @param startPosition amount of results to skip @param maxResult amount of
	 * results @return {@link MainGame} ids for a given {@link Serie} id
	 */
	 ...
	 *
	 * @param startPosition amount of results to skip @param maxResult amount of
	 * results @return {@link MainGame} ids sorted by launchdate
	 */
	 ...
	 *
	 * @param startPosition amount of results to skip @param maxResult amount of
	 * results @return ids of {@link MainGame}s which are playable, so are
	 * active and are released
	 */
