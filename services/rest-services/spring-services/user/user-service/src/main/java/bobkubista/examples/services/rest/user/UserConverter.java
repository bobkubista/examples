 ...
 */
@Named
public class UserConverter extends AbstractEntityToDomainConverter<User, UserCollection, UserEntity>
		implements EntityToDomainConverter<User, UserCollection, UserEntity> {
