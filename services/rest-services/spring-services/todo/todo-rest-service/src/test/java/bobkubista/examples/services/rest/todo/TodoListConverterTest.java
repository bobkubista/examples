 ...
 *
 */
public class TodoListConverterTest
		extends AbstractTestEntityToDomainConverter<TodoList, TodoListCollection, TodoListEntity> {
	...
	protected void assertDomainObject(final TodoList domainModelObject, final TodoListEntity entity) {
		...
		Assert.assertEquals(entity.getTodoList()
				.size(),
				domainModelObject.getTodoList()
						.size());
	}
