...
import bobkubista.examples.utils.services.spring.jpa.entity.EntityObject;
import bobkubista.examples.utils.services.spring.jpa.entity.IdentifiableEntity;
import bobkubista.examples.utils.services.spring.jpa.services.IdentifiableEntityService;

/**
 * @author bkubista @param <DMO> {@link IdentifiableDomainObject} @param
 *         <DMOL> {@link DomainObjectCollection} @param
 *         <EO> {@link IdentifiableEntity} @param <ID> Identifier
 */
public abstract class AbstractEntityToDomainConverter<DMO extends IdentifiableDomainObject<ID>, DMOL extends DomainObjectCollection<DMO>, EO extends IdentifiableEntity<ID>, ID extends Serializable>
	 ...
	 *
	 * @param entity
	 *            the {@link EntityObject} to convert @return the converted
	 *            {@link DomainObject}
	 */
	 ...
	 *
	 * @param domainModelObject
	 *            the {@link DomainObject} to convert @param entityObject the
	 *            {@link EntityObject} to convert to
	 */
