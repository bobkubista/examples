 ...
 * @author bkubista
 *
 * @param <TYPE> {@link AbstractGenericFunctionalIdentifiableEntity} @param <ID>
...
public interface FunctionalIdentifiableEntityService<TYPE extends AbstractGenericFunctionalIdentifiableEntity<ID>, ID extends Serializable>
	...
	/**
	 *
	 * @param fId functional id @return the identifier <code>ID</code> for the
	 * given functional id
	 */
	...
	/**
	 *
	 * @param identifier the functioanl identifier to use @return search for
	 * <code>TYPE</code> which has the identifier as part of the functional id
	 */
