 ...
 * @author bkubista
 *
 * @param <TYPE> an {@link AbstractIdentifiableEntity} 
 * @param <ID> identifier which is {@link Serializable}
 */
public interface GenericDao<TYPE extends AbstractIdentifiableEntity<ID>, ID extends Serializable> {

	/**
	 *
	 * @param entity the TYPE to check for @return does the entity exist
	 */
	 ...
	 *
	 * @param object the <code>TYPE</code> object to insert 
	 ...
	 *
	 * @param object the <code>TYPE</code> object to update
	 */
	 ...
	 * @param maxResult the amount of result per page
	 * @return a {@link Collection} of <code>TYPE</code>
	 */
	public abstract Collection<TYPE> getAll(String sort, int page, int maxResult);

	/**
	 * get a <code>TYPE</code> object by its <code>ID</code> id
	 *
	 * @param id the <code>ID</code> id to search for 
