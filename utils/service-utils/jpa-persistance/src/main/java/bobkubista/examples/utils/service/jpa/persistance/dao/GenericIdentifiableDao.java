 ...
 */
public interface GenericIdentifiableDao<TYPE extends AbstractIdentifiableEntity> extends GenericDao<TYPE> {
	 ...
	 */
	public default Optional<TYPE> getById(final Long id) {
