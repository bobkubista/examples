 ...
 *            identifier
 */
public abstract class AbstractIdentifiableDaoIT<TYPE extends AbstractIdentifiableEntity>
		implements BaseIntegrationDaoTest {
	 ...
	 */
	protected abstract GenericIdentifiableDao<TYPE> getDao();
