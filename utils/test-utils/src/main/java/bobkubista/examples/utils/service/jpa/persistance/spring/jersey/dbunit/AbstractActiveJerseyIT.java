 ...
 */
public abstract class AbstractActiveJerseyIT<TYPE extends AbstractGenericActiveDomainObject, COL extends AbstractGenericDomainObjectCollection<TYPE>>
		extends AbstractFunctionalJerseyIT<TYPE, COL> {
	/**
