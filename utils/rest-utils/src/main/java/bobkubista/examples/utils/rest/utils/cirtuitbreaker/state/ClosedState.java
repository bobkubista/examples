...
public final class ClosedState implements CircuitBreakerState {
    ...
    public boolean isRequestAllowed() {
        return this.circuitBreaker.getPolicy().isHealthy(this.circuitBreaker.getScope()) ? true : this.circuitBreaker.changeState(new OpenState(this.circuitBreaker)).isRequestAllowed();
    }
}
