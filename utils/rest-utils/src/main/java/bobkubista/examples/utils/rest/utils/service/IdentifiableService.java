 ...
 *
 */
public interface IdentifiableService<TYPE extends AbstractGenericIdentifiableDomainObject, COL extends AbstractGenericDomainObjectCollection<TYPE>> {
	 ...
	 */
	GenericETagModifiedDateDomainObjectDecorator<TYPE> getByID(
			GenericETagModifiedDateDomainObjectDecorator<TYPE> object);
	 ...
	 */
	GenericETagModifiedDateDomainObjectDecorator<TYPE> getByID(Long id);
	 ...
	 *         of TYPE
	 */
	GenericETagModifiedDateDomainObjectDecorator<TYPE> update(
			GenericETagModifiedDateDomainObjectDecorator<TYPE> object);
