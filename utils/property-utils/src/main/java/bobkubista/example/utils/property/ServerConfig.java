...
public interface ServerConfig {
     ...
     *
     * @param key
     *            The key to add the property to. @param value The value to add.
     */
     ...
     *
     * @param key
     *            The configuration key. @return The associated BigDecimal if
     ...
     *
     * @param key
     *            The configuration key. @return The associated boolean.
     *
     ...
     *
     * @param key
     *            The configuration key. @return The associated double.
     *
     * @throws ConversionException
     ...
     *
     * @param key
     *            The configuration key. @return The associated int.
     *
     * @throws ConversionException
     ...
     *
     * @param prefix
     *            The prefix to test against. @return An Iterator of keys that
     *            match the prefix. @see #getKeys()
     */
     ...
     *
     * @param key
     *            The configuration key. @return The associated long.
     *
     * @throws ConversionException
     ...
     *
     * @param key
     *            property to retrieve @return the value to which this
     *            configuration maps the specified key, or null if the
     *            configuration contains no mapping for this key.
     */
     ...
     *
     * @param key
     *            The configuration key. @return The associated string.
     *
     * @throws ConversionException
     ...
     *
     * @param key
     *            The configuration key. @return The associated string array if
     *            key is found.
     *
     * @throws ConversionException
     ...
     *
     * @param key
     *            The key of the property to change @param value The new value
     */
