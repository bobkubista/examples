 ...
 * AbstractGenericFunctionalIdentifiableDomainObject} @param <ID> the identifier
 * of the {@link AbstractGenericFunctionalIdentifiableDomainObject}
 *
 */
public interface FunctionalIdentifiableApi<DMO extends AbstractGenericFunctionalIdentifiableDomainObject<ID>, ID extends Serializable> extends IdentifiableApi<DMO, ID> {
	 ...
	 *
	 * @param identifier the identfier @return the <code>DMO</code> @return
	 * {@link Response}
	 */
	@GET
	 ...
	 *
	 * @param fId functional id @return the <code>ID</code> @return {@link
	 * Response}
	 */
	@GET
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
