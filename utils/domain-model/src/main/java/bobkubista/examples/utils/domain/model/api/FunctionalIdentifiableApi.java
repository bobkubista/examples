 ...
 * FunctionalIdentifiableDomainObject} @param <ID> the identifier of the {@link
 * FunctionalIdentifiableDomainObject}
 */
public interface FunctionalIdentifiableApi<DMO extends FunctionalIdentifiableDomainObject<ID>, ID extends Serializable> extends IdentifiableApi<DMO, ID> {
	 ...
	 *
	 * @param identifier the identfier @return the <code>DMO</code>
	 */
	@GET
	 ...
	 *
	 * @param fId functional id @return the <code>ID</code>
	 */
	@GET
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	@Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
